    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultPackages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "float", nullable: false),
                    Months = table.Column<int>(type: "int", nullable: false),
                    DefaultPackageId = table.Column<int>(type: "int", nullable: true),
                    BranchRegisteredId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_Branches_BranchRegisteredId",
                        column: x => x.BranchRegisteredId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Packages_DefaultPackages_DefaultPackageId",
                        column: x => x.DefaultPackageId,
                        principalTable: "DefaultPackages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Packages_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Packages_BranchRegisteredId",
                table: "Packages",
                column: "BranchRegisteredId");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_DefaultPackageId",
                table: "Packages",
                column: "DefaultPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_Packages_MemberId",
                table: "Packages",
                column: "MemberId");
